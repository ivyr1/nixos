...
:root {
  ...
  --noti-bg: 35, 35, 38;
  --noti-bg-alpha: 1.0;
  --noti-bg-darker: rgb(27, 28, 30);
  --noti-bg-hover: rgb(44, 45, 49);
  --noti-bg-focus: rgba(53, 54, 59, 0.8);
  --noti-close-bg: rgb(44, 45, 49);
  --noti-close-bg-hover: rgb(222, 93, 104);
  --text-color: rgb(167, 170, 176);
  --text-color-disabled: rgb(90, 91, 94);
  --bg-selected: rgb(87, 165, 229);
...
@define-color cc-bg rgba(27, 28, 30, 0.95);
@define-color noti-border-color #ffffff;
@define-color noti-bg rgba(35, 35, 38, 1.0);
@define-color noti-bg-opaque rgb(35, 35, 38);
@define-color noti-bg-darker rgb(27, 28, 30);
@define-color noti-bg-hover rgb(44, 45, 49);
@define-color noti-bg-hover-opaque rgb(44, 45, 49);
@define-color noti-bg-focus rgba(53, 54, 59, 0.8);
@define-color noti-close-bg rgb(44, 45, 49);
@define-color noti-close-bg-hover rgb(222, 93, 104);
@define-color text-color rgb(167, 170, 176);
@define-color text-color-disabled rgb(90, 91, 94);
@define-color bg-selected rgb(87, 165, 229);
...
.per-app-volume {
  background-color: var(--noti-bg-darker);
  margin: 8px;
  margin-bottom: 0;
  border-radius: var(--border-radius);
}
